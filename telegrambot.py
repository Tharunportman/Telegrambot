...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5971410016:AAHlVUeZ6ED_1eZpp8tA1Vo_HMgxlOJ34_M"
else:
    tgkey = tgenv
print(tgenv)
...
def runn(bot, update):
    ...
    if "/username " in update.message.text:
        ...
        comput = threading.Thread(target=interact, args=(
            bot, update, botname, username, new,))
        comput.start()
